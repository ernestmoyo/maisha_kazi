  ...
  sections: [
    {
      ...
      children: [
        ...
        roleTable([
          ...
          ['Youth Worker', 'amina@demo.com', 'View assigned jobs, upload proof, earnings'],
          ['Youth Worker', 'baraka@demo.com', 'View assigned jobs, upload proof, earnings'],
        ]),
        ...
        spacer(),
        statusTable([
          ['OPEN',                 'Job posted by a client, awaiting coordinator assignment',             'Coordinator'],
          ...
          ['PENDING_CONFIRMATION', 'Youth uploaded proof photo; waiting for client to confirm',           'Client'],
          ['COMPLETED',            'Client confirmed the work. Payment recorded.',                        'Coordinator (optional review)'],
        ...
        spacer(),
        note(
          'The system automatically moves a job from IN_PROGRESS → PENDING_CONFIRMATION when the youth uploads a proof photo. ' +
        ...
        heading2('5.2  Accepting & Starting a Job'),
        numberedStep(1, 'When a job is assigned, you receive a notification in-app.'),
        numberedStep(2, 'Open My Jobs and tap the job card to view details: location, description, fee, and coordinator notes.'),
        numberedStep(3, 'Use the map on the job detail page to navigate to the location.'),
        numberedStep(4, 'When you arrive, tap Start Job. Status moves to IN_PROGRESS.'),
        note('Always tap Start Job before beginning work — this timestamps your arrival and protects you in case of a dispute.'),
        spacer(),

        heading2('5.3  Uploading Proof of Completion'),
        ...
        numberedStep(4, 'Status moves to PENDING_CONFIRMATION. You will be paid once the client confirms.'),
        ...
        heading2('5.4  Tracking Earnings'),
        ...
        bullet('Check if the job is still in PENDING_CONFIRMATION — the client has not yet confirmed.'),
        spacer(),
